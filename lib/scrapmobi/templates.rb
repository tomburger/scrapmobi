...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookID" version="2.0">
    <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
        <dc:title>ScrapMobi</dc:title> 
        <dc:creator opf:role="aut">Tom Burger</dc:creator>
        <dc:language>en-US</dc:language> 
        <dc:rights>Public Domain</dc:rights> 
        <dc:publisher>burger.cz</dc:publisher> 
        <dc:identifier id="BookID" opf:scheme="UUID">tomburger-scrapmobi-sample</dc:identifier>
    </metadata>
    <manifest>
...
<head>
    <meta name="dtb:uid" content="tomburger-scrapmobi-sample"/>
